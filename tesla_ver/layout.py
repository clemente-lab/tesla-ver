    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                html.Div([dcc.Slider(id="year-slider", min=0, max=1, value=None, marks={}, updatemode="drag")]),
                html.Div(
                    [
                        html.P("Y Axis"),
                        dcc.Dropdown(
                            id="y_dropdown", options=[], value=None, placeholder="Y Axis Values", className="dropdowns"
                        ),
                    ],
                ...
                html.Div(
                    [
                        html.P("X Axis"),
                        dcc.Dropdown(
                            id="x_dropdown", options=[], value=None, placeholder="X Axis Values", className="dropdowns"
                        ),
                    ],
